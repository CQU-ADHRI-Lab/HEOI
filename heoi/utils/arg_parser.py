...
parser.add_argument('dataset', type=str, choices=['somethingv2'])
...
parser.add_argument('--lr_steps', default=[50, 100], type=float, nargs="+", metavar='LRSteps', help='epochs to decay learning rate by 10')
